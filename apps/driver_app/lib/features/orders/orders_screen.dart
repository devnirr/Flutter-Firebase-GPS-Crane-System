...
/// Open work this chofer could take: unassigned, and in their truck class.
/// Anything else is either somebody else's job or one they cannot take.
///
/// Shared by the Pedidos tab and the count on its icon in the bottom bar.
final availableOrdersProvider = Provider<List<Service>>((ref) {
...
/// The Pedidos tab: what the chofer made today, and the open work.
              ...
              children: [
                ...
                if (!driver.isOnline)
                  InlineNotice(
                    ...
                    // The switch lives with the map, where the chofer can see
                    // what going online will put in front of them.
